...
function draw (canvas, timeElapsed, currentTime) {
    ...
    if (b) {
        // draw bullet
        c.drawImage(b.image, b.x, b.y);
    }
    // draw avatar
    c.drawImage(avatar.image, avatar.x, avatar.y);
}
...
var sfx = {
    fire: new Audio("missile.wav"),
    enemyHit: new Audio("hit.wav"),
    avatarHit: new Audio("hurt.wav")
}